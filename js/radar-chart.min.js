...
function RadarChart(id, data, options, chartName) {
    var cfg = {
        w: 70,				//Width of the circle
        h: 70,				//Height of the circle
        margin: {top: 0, right: 0, bottom: 20, left: 0}, //The margins of the SVG
        levels: 3,				//How many levels or inner circles should there be drawn
        maxValue: 10, 			//What is the value that the biggest circle will represent
        labelFactor: 1.7, 	//How much farther than the radius of the outer circle should the labels be placed
    ...
    blobWrapper.selectAll(".radarCircle")
        ...
        .style("fill", function(d,i,j) { return "#57CE36"; })
